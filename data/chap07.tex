...
\begin{tabular}{c|c|c}
\toprule
Arrival rate (requests/s) & \Project throughput (requests/s) & FasterTransformer throughput (requests/s) \\
\midrule
50 & 48.302 & - \\
100 & 83.190 & 53.736 \\
250 & 105.239 & 54.399 \\
...
\begin{tabular}{c|c|c}
\toprule
Arrival rate (requests/s) & \Project throughput (tokens/s) & FasterTransformer throughput (tokens/s) \\
\midrule
50 & 3119.0 & - \\
100 & 5373.75 & 3471.18 \\
250 & 6806.7 & 3518.42 \\
